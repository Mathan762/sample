...
function registerClick() {
    if (document.querySelector(".register_portal").onclick) {
        ...
        document.getElementById("container-reg").style.visibility="visible";
        document.getElementById("container-reg").style.animation="portal 2s";
...
function loginButton()
{
    ...
    else if (document.getElementById("username").value)
    {
        ...
        if (document.getElementById("username").value == "admin@gmail.com")
        {
